...
export default function FooterBrunpena({
    ...
    return (
        <footer className="bg-gray-900 text-gray-300 w-full flex flex-row justify-around mt-max">
            ...
            <div className="flex items-center gap-3 m-4">
                <span className="text-xs text-gray-400 mr-2 hidden sm:inline">Desenvolvido por</span>
                ...
                >
                    <span className="sr-only">GitHub - brunpena</span>
                ...
                >
                    <span className="sr-only">GitHub - PedrinnhoUtumi</span>
