        ...
        <div className="w-full px-4 py-6">
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input name="categoria" value={editingBem.categoria ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Descrição</span>
                    <input name="descricao_do_bem" value={editingBem.descricao_do_bem ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Marca</span>
                    <input name="marca" value={editingBem.marca ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Modelo</span>
                    <input name="modelo" value={editingBem.modelo ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Localização</span>
                    <input name="localizacao_text" value={editingBem.localizacao_text ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Valor Aquisição</span>
                    <input name="valor_aquisicao" type="number" value={editingBem.valor_aquisicao ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Valor Residual</span>
                    <input name="valor_residual" type="number" value={editingBem.valor_residual ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Estado de Conservação</span>
                    <input name="estado_conservacao" value={editingBem.estado_conservacao ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Data Aquisição</span>
                    <input name="data_aquisicao" type="date" value={editingBem.data_aquisicao ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Data Baixa</span>
                    <input name="data_baixa" type="date" value={editingBem.data_baixa ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col">
                    <span className="text-sm">Depreciação (%)</span>
                    <input name="depreciacao_percent" type="number" value={editingBem.depreciacao_percent ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>

                    <label className="flex flex-col md:col-span-2">
                    <span className="text-sm">Justificativa Baixa</span>
                    <textarea name="justificativa_baixa" value={editingBem.justificativa_baixa ?? ""} onChange={handleChange} className="border rounded px-2 py-1" />
                    </label>
                </div>
