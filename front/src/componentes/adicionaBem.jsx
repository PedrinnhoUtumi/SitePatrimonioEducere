...
export default function AdcionaBem() {
    ...
    return (
        ...
        //     {message && (
        //         <div
        //             className={`mt-4 p-3 rounded ${message.type === "error" ? "bg-red-100 text-red-800" : "bg-green-100 text-green-800"
        //                 }`}
        //         >
        //             {message.text}
        //         </div>
                ...
                <div className="flex flex-col gap-4">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full mt-1 p-2 border rounded-lg focus:ring-2 focus:ring-indigo-400 outline-none"
                        >
                            {/* Opções já existentes + novas do HTML antigo */}
                            <option>Equipamentos</option>
